...
schools = {
    ...
    "waterloo" : "In graduate study, I intend to focus on combinatorial optimization. At the University of Waterloo, I am especially interested in working with Professors Joseph Cheriyan and Peter Nelson, whose work on graph connectivity and matroids respectively is closely aligned with my interests.",
    ...
    "washington" : "In graduate study, I intend to focus on algorithms. At University of Washington-Seattle, I am especially interested in working with Professors Shayan Gharan and Anna Karlin on [NEED THEIR RESEARCH AREAS].",

    "uwmadison" : "In graduate study, I intend to focus on algorithms. At UW-Madison, I am especially interested in working with Professor Alberto Del Pia on [NEED HIS RESEARCH AREA].",
    
    "stanford" : "In graduate study, I intend to focus on algorithms. At Stanford, I am especially interested in working with Professor Aviad Rubenstein on [NEED HIS RESEARCH AREA]."
}
